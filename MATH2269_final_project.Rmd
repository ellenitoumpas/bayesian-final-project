...
data.frame(columns = integer(), rows = integer()) %>%
  ...
  format_table(p_caption = "Dimensions")
...
## printed in landscape so there isx extra real estate in the width of the table but all header previews still contained to one page?s
