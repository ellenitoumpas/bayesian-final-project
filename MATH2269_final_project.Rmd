...
data_cleaned <- subsample(data_cleaned, training_data)
...
data_cleaned <- subsample_selection(data_cleaned, trial_type, sample_size_list)
...
initial_values_list <- get_initial_values(data_cleaned)
...
if(hasnt_run(model_trial_type)){
    ...
    returned_values <- setup_run_JAGS_trial(data = subsampled_data, predictor = "pm10", predictions = xPred, mu_list = mus,
                                            var_list = vars, initial_values = initial_values_list, params = use_parameters,
                                            par_trial_name = model_trial_type, num_predictions = nrow(xPred))
...
```{r Regression Diagnostics, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap= "", fig.width=10}

view_regression_diagnostics_images(trial_type)

```

```{r Prediction Diagnostics, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap= "", fig.width = 10}
...
```{r Posterior Images, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap= "", fig.width = 10}
